    ...
    <div className="page-container animate-fade-in p-4 md:p-8 w-full max-w-[1600px] mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 pb-32 md:pb-10">
        ...
        <div className="flex flex-col gap-6 md:gap-8 h-full">
          ...
          <div className="card bg-primary text-white p-6 md:p-8 relative overflow-hidden shadow-md flex flex-col justify-between shrink-0" style={{ height: '260px' }}>
          ...
          <div className="md:hidden grid grid-cols-3 gap-3 shrink-0">
            {[
        ...
        <div className="flex flex-col gap-6 md:gap-8 h-full">
          ...
          <div className="hidden md:flex flex-col justify-center shrink-0" style={{ height: '260px' }}>
            <h2 className="font-semibold text-text text-lg mb-4 opacity-0 select-none absolute">Quick Actions (Hidden Header)</h2>
            <div className="grid grid-cols-4 gap-4">
              {[
                { name: 'Add Transaction', icon: Plus, href: '/transactions/add' },
                { name: 'Budget', icon: Wallet, href: '/budget' },
                { name: 'Bills', icon: CalendarDays, href: '/bills' },
                { name: 'Goals', icon: Target, href: '/goals' },
              ].map(item => (
          ...
          <div className="flex-1 flex flex-col min-h-0">
            ...
            <div className="card p-6 shadow-sm flex flex-col justify-between relative overflow-hidden group min-h-[240px]">
              ...
              <div className="relative z-10 flex justify-between items-center mb-6 border-b border-border/50 pb-4 shrink-0">
                <div>
